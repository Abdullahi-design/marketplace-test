      ...
      <CollapsibleSection
        title={
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-green-600 font-medium">{listing.status}</span>
          </div>
        }
        defaultOpen
        border={false}
          ...
          <div className="col-span-12 md:col-span-4">
            <Section title="">
              ...
              <div className="aspect-[4/3] bg-gray-50 border border-gray-200 rounded-md relative overflow-hidden">
                <Image src="/assets/box-1.svg" alt="Package" fill className="object-contain p-6" sizes="(max-width:768px) 100vw, 33vw" />
              </div>
              <div className="mt-3 grid grid-cols-4 gap-3">
                {['/assets/box-2.svg','/assets/box-3.svg','/assets/box-3.svg','/assets/box-4.svg'].map((src, idx) => (
                  <div key={idx} className="aspect-square rounded-md bg-gray-50 border border-gray-200 relative overflow-hidden">
                    <Image src={src} alt={`Package thumbnail ${idx+1}`} fill className="object-contain p-2.5" sizes="(max-width:768px) 25vw, 8vw" />
                  </div>
                ))}
              </div>
            </Section>
